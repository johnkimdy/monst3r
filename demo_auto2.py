...
def get_reconstructed_scene(
    ...
    final_loss = loss if mode == GlobalAlignerMode.PointCloudOptimizer else None
    # Save final loss maybe
    with open(f"{save_folder}/final_loss.txt", "w") as f:
    ...
    # Return final_loss along with the others
    return scene, outfile, imgs_out, final_loss
...
if __name__ == '__main__':
    ...
    if args.input_dir is not None:
        ...
        scene, outfile, imgs, final_loss = recon_fun(
